...
const title = 'AWS Cloud Resume Challenge';
const description =
    ...
    <>
      <ProjectContainer>
        ...
        <ProjectHeader
          ...
          url="https://blog-daniel-caleb.hashnode.dev/my-cloud-resume-challenge-a-journey-from-zero-to-hero"
          roles={roles}
        />
        ...
        <ProjectSection>
          <ProjectTextRow>
            <ProjectSectionHeading>Core Components and Steps</ProjectSectionHeading>
            <ProjectSectionText>
              The challenge is typically broken down into two main sections: the Front-End 
              (the website) and the Back-End (the visitor counter API), all tied together with Automation.
            </ProjectSectionText>
          </ProjectTextRow>
        </ProjectSection>
        <ProjectSection light={isDark}>
          <ProjectSectionContent>
            ...
            <ProjectTextRow>
              <ProjectSectionHeading>The Front-End (Static Website)</ProjectSectionHeading>
              <ProjectSectionText>
                The challenge starts with creating the front-end — a static personal resume 
                website built using HTML, CSS, and JavaScript. This site serves as your 
                digital resume, showcasing your professional background, skills, and experience. 
                Once developed, it is hosted on Amazon S3 using the Static Website Hosting feature, 
                which allows you to serve web pages directly from an S3 bucket. To improve global performance, 
                reduce latency, and enable secure HTTPS access, you integrate Amazon CloudFront, 
                which acts as a Content Delivery Network (CDN).
              </ProjectSectionText>
              <ProjectSectionText>
                Additionally, a custom domain is configured using Amazon Route 53, where DNS 
                records are linked to the CloudFront distribution, giving your site a 
                professional and polished URL.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
        <ProjectSection>
          <ProjectSectionContent>
            ...
            />
            <ProjectTextRow>
              <ProjectSectionHeading>The Back-End (The Visitor Counter)</ProjectSectionHeading>
              <ProjectSectionText>
                To make the website more dynamic, the next component involves 
                building a serverless backend that tracks the number of visitors
                 to your resume site. This is achieved using AWS Lambda, a serverless 
                 compute service that runs your code in response to API requests. 
                 The visitor data is stored in a DynamoDB table, which serves as a scalable NoSQL database.
              </ProjectSectionText>
              <ProjectSectionText>
                The Lambda function retrieves and updates the visitor count in real time. 
                To expose this functionality to the front-end, you set up Amazon API Gateway, 
                which provides a secure API endpoint that the website’s JavaScript can call. 
                Proper IAM roles and permissions are configured to ensure that Lambda and DynamoDB interact securely.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
            ...
            <ProjectSectionColumns width="full">
              <ProjectSectionContent width="full">
                <ProjectTextRow width="s">
                  <ProjectSectionHeading>Automation and DevOps (CI/CD and IaC)</ProjectSectionHeading>
                  <ProjectSectionText>
                    The project strongly emphasizes automation and modern DevOps practices. 
                    Instead of deploying resources manually, you use Infrastructure as Code (IaC) tools such as 
                    AWS CloudFormation or Terraform to define and deploy your entire infrastructure consistently. 
                    This approach ensures version control and repeatability across environments.
                  </ProjectSectionText>
                  <ProjectSectionText>
                    You then set up a Continuous Integration and Continuous Deployment (CI/CD) pipeline using GitHub Actions 
                    (or AWS CodePipeline). This pipeline automatically updates your S3-hosted website and redeploys your 
                    Lambda backend whenever changes are pushed to the GitHub repository. This integration demonstrates a
                     real-world DevOps workflow where testing, deployment, and updates are fully automated.
                  </ProjectSectionText>
                </ProjectTextRow>
              </ProjectSectionContent>
              <Image
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow>
              <ProjectSectionHeading>Documentation and Presentation</ProjectSectionHeading>
              <ProjectSectionText>
                The final stage of the challenge focuses on documentation and presentation. 
                You write a detailed blog post or LinkedIn article explaining your design choices, 
                architecture, tools used, and lessons learned throughout the project. 
                This step not only helps reinforce your understanding but also showcases your 
                ability to communicate technical work clearly and professionally.
              </ProjectSectionText>
            </ProjectTextRow>
            <Image
              raised
                ...
                <ProjectSection>
                  <ProjectSectionContent>
                    <ProjectTextRow center>
                      ...
                      <ProjectSectionText>
                        Absolutely! This Cloud Resume Challenge was a rollercoaster 
                        ride of frustration and triumph. Did I end up with the most 
                        aesthetically pleasing resume ever? Maybe not. 
                        Did I learn a whole heck of a lot about cloud technologies? 
                        Heck yes! Most importantly, did I create a resume that showcases my willingness to learn and adapt? 
                        You bet your sweet pixels I did.
                      </ProjectSectionText>
                    </ProjectTextRow>
                  </ProjectSectionContent>
                </ProjectSection>
                ...
                <ProjectSection>
                  <ProjectSectionContent width="xl">
                    <ProjectTextRow justify="end" width="s">
                      ...
                      <ProjectSectionText>
                        How about you play around with this 3D model of the earth for a bit?
                      </ProjectSectionText>
                    </ProjectTextRow>
                  </ProjectSectionContent>
                </ProjectSection>
                ...
                <ProjectSection>
                  <ProjectSectionContent width="xl">
                    <ProjectTextRow justify="start" width="s">
                      ...
                      <ProjectSectionText>
                        You can click and drag to orbit around and freely explore at any time.
                      </ProjectSectionText>
                    </ProjectTextRow>
                  </ProjectSectionContent>
                </ProjectSection>
                ...
                <ProjectSection>
                  <ProjectSectionContent width="xl">
                    <ProjectTextRow justify="end" width="s">
                      ...
                      <ProjectSectionText>
                        The earth model is animated to reveal its internal layers mantle, outer core, and 
                        inner core, demonstrating how 3D visualization can enhance understanding of complex systems. 
                        This animation is triggered as you progress through the interactive sections, 
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow center centerMobile noMargin>
              ...
              <ProjectSectionHeading>Project History</ProjectSectionHeading>
              <ProjectSectionText>
                The <Link href="https://cloudresumechallenge.dev/">AWS Cloud Resume Challenge</Link>, created by Forrest Brazeal, is a hands-on project to build a serverless resume website using AWS services, yielding valuable outcomes for participants.{' '}
                <Link href="https://blog-daniel-caleb.hashnode.dev/my-cloud-resume-challenge-a-journey-from-zero-to-hero">
                  My Blog!
                </Link>{' '}
              </ProjectSectionText>
            </ProjectTextRow>
